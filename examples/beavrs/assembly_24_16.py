...
# Define fuel pin
fp = FuelPin(fuel=Fuel24, fuel_radius=0.39218, gap=He, gap_radius=0.40005, clad=Clad, clad_radius=0.45720)
...
asmbly.track_spacing = 0.05
asmbly.dancoff_num_azimuthal_angles = 32
asmbly.dancoff_track_spacing = 0.1
