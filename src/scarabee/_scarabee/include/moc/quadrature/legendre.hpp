...
// N = 2
template <>
inline const std::array<double, 1> Legendre<2>::sin_ = {
    std::sqrt(1. - std::pow(5.77350269189625764509148780501957456e-01, 2.))};
template <>
inline const std::array<double, 1> Legendre<2>::invs_sin_ = {1. / sin_[0]};
template <>
inline const std::array<double, 1> Legendre<2>::wgt_ = {
    1.00000000000000000000000000000000000e+00};
template <>
inline const std::array<double, 1> Legendre<2>::wsin_ = {wgt_[0] * sin_[0]};
template <>
inline const std::array<double, 1> Legendre<2>::polar_angle_ = {
    std::asin(sin_[0])};

// N = 4
template <>
inline const std::array<double, 2> Legendre<4>::sin_ = {
...
template <>
inline const std::array<double, 2> Legendre<4>::invs_sin_ = {1. / sin_[0],
                                                             1. / sin_[1]};
template <>
inline const std::array<double, 2> Legendre<4>::wgt_ = {
    6.52145154862546142626936050778000593e-01,
    3.47854845137453857373063949221999407e-01};
template <>
inline const std::array<double, 2> Legendre<4>::wsin_ = {wgt_[0] * sin_[0],
                                                         wgt_[1] * sin_[1]};
template <>
inline const std::array<double, 2> Legendre<4>::polar_angle_ = {
    std::asin(sin_[0]), std::asin(sin_[1])};

// N = 6
template <>
inline const std::array<double, 3> Legendre<6>::sin_ = {
...
template <>
inline const std::array<double, 3> Legendre<6>::invs_sin_ = {
    1. / sin_[0], 1. / sin_[1], 1. / sin_[2]};
template <>
inline const std::array<double, 3> Legendre<6>::wgt_ = {
...
template <>
inline const std::array<double, 3> Legendre<6>::wsin_ = {
    wgt_[0] * sin_[0], wgt_[1] * sin_[1], wgt_[2] * sin_[2]};
template <>
inline const std::array<double, 3> Legendre<6>::polar_angle_ = {
    std::asin(sin_[0]), std::asin(sin_[1]), std::asin(sin_[2])};

// N = 8
template <>
inline const std::array<double, 4> Legendre<8>::sin_ = {
...
template <>
inline const std::array<double, 4> Legendre<8>::invs_sin_ = {
    1. / sin_[0], 1. / sin_[1], 1. / sin_[2], 1. / sin_[3]};
template <>
inline const std::array<double, 4> Legendre<8>::wgt_ = {
...
template <>
inline const std::array<double, 4> Legendre<8>::wsin_ = {
    wgt_[0] * sin_[0], wgt_[1] * sin_[1], wgt_[2] * sin_[2], wgt_[3] * sin_[3]};
template <>
inline const std::array<double, 4> Legendre<8>::polar_angle_ = {
    std::asin(sin_[0]), std::asin(sin_[1]), std::asin(sin_[2]),
    std::asin(sin_[3])};

// N = 10
template <>
inline const std::array<double, 5> Legendre<10>::sin_ = {
...
template <>
inline const std::array<double, 5> Legendre<10>::invs_sin_ = {
    1. / sin_[0], 1. / sin_[1], 1. / sin_[2], 1. / sin_[3], 1. / sin_[4]};
template <>
inline const std::array<double, 5> Legendre<10>::wgt_ = {
...
template <>
inline const std::array<double, 5> Legendre<10>::wsin_ = {
    wgt_[0] * sin_[0], wgt_[1] * sin_[1], wgt_[2] * sin_[2], wgt_[3] * sin_[3],
    wgt_[4] * sin_[4]};
template <>
inline const std::array<double, 5> Legendre<10>::polar_angle_ = {
    std::asin(sin_[0]), std::asin(sin_[1]), std::asin(sin_[2]),
    std::asin(sin_[3]), std::asin(sin_[4])};

// N = 12
template <>
inline const std::array<double, 6> Legendre<12>::sin_ = {
...
template <>
inline const std::array<double, 6> Legendre<12>::invs_sin_ = {
    1. / sin_[0], 1. / sin_[1], 1. / sin_[2],
    1. / sin_[3], 1. / sin_[4], 1. / sin_[5]};
template <>
inline const std::array<double, 6> Legendre<12>::wgt_ = {
...
template <>
inline const std::array<double, 6> Legendre<12>::wsin_ = {
    wgt_[0] * sin_[0], wgt_[1] * sin_[1], wgt_[2] * sin_[2],
    wgt_[3] * sin_[3], wgt_[4] * sin_[4], wgt_[5] * sin_[5]};
template <>
inline const std::array<double, 6> Legendre<12>::polar_angle_ = {
    std::asin(sin_[0]), std::asin(sin_[1]), std::asin(sin_[2]),
