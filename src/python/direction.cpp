...
void init_Direction(py::module& m) {
  ...
  "A vector in R2 of unit length.\n\n"
  "Arguments:\n"
  "    phi  angle with x-axis, in radians", py::arg("phi"))
  
  .def("__add__", [](const Direction& d1, const Direction& d2) { return d1 + d2; })
  
  .def("__add__", [](const Direction& d, const Vector& v) { return d + v; })
  
  .def("__radd__", [](const Direction& d, const Vector& v) { return v + d; })
  
  .def("__sub__", [](const Direction& d1, const Direction& d2) { return d1 - d2; })
  
  .def("__sub__", [](const Direction& d, const Vector& v) { return d - v; })

  .def("__rsub__", [](const Direction& d, const Vector& v) { return v - d; })
  
  .def("__mul__", [](const Direction& d1, const Direction& d2) { return d1 * d2; })
  
  .def("__mul__", [](const Direction& d, const Vector& v) { return d * v; })
  
  .def("__rmul__", [](const Direction& d, const Vector& v) { return v * d; })
