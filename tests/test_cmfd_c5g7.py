...
"""
Integration test for CMFD K-eigenvalue mode on C5G7 benchmark problem
"""

class TestCMFDC5G7:

    # C5G7 should never take this long, test most likely is broken
    # if it takes more than 1000 seconds
