...
void test() {
  ...
  UO2->fissile_ = true;
  UO2->Etr_ = {1.77949E-01, 3.29805E-01, 4.80388E-01, 5.54367E-01,
  ...
  UO2->nu_ = NDArray<double>(
      {2.78145, 2.47443, 2.43383, 2.43380, 2.43380, 2.43380, 2.43380}, {1, 7});
  UO2->chi_ = NDArray<double>(
      {5.87910E-01, 4.11760E-01, 3.39060E-04, 1.17610E-07, 0., 0., 0.}, {1, 7});
  UO2->Es_tr_ = NDArray<double>(
  ...
  H2O->fissile_ = false;
  H2O->Etr_ = {1.59206E-01, 4.12970E-01, 5.90310E-01, 5.84350E-01,
  ...
  H2O->Es_tr_ = NDArray<double>(
      {4.44777E-02, 1.13400E-01, 7.23470E-04, 3.74990E-06, 5.31840E-08,
